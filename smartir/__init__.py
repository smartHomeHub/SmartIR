...
CONF_CONTROLLER_SEND_SERVICE_HOST = "controller_send_service_host"
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Optional(CONF_CONTROLLER_SEND_SERVICE_HOST): cv.string,
...
class SmartIRClimate(ClimateDevice, RestoreEntity):
    def __init__(self, hass, config, device_data):
        ...
        self._controller_send_service_host = config.get(CONF_CONTROLLER_SEND_SERVICE_HOST)
        ...
        self._controller = Controller(
            ...
            self._controller_send_service_host)
