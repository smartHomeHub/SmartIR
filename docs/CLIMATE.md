...
Find your device's brand code [here](CLIMATE.md#available-codes-for-climate-devices) and add the number in the `device_code` field. If your device is not working, you will need to learn your own codes and place the Json file in `smartir/codes/climate` subfolders. [Callum Gare](https://github.com/callumgare/BroadlinkIRTools) has a functional fork of [the amazing web-based app](https://callumgare.github.io/BroadlinkIRTools/) Keite Trần developed for this job.
